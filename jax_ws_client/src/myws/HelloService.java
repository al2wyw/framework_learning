 ...
 * 
 */
@WebServiceClient(name = "helloService", targetNamespace = "http://myws/", wsdlLocation = "http://localhost:8080/jax_ws/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://myws/", "helloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://myws/", "helloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myws/", "helloPort"), Hello.class, features);
    }
