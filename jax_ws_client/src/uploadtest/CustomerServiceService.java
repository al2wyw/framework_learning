 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceService", targetNamespace = "http://uploadtest/", wsdlLocation = "http://localhost:8080/jax_ws/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICESERVICE_QNAME = new QName("http://uploadtest/", "CustomerServiceService");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://uploadtest/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://uploadtest/", "CustomerServicePort"), CustomerService.class, features);
    }
